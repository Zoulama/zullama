		...
		if($(".video-background").length>0) {
			if (Modernizr.touch) {
				$(".video-background").vide({
					mp4: "/z_assets/videos/background-video.mp4",
					webm: "/z_assets/videos/background-video.webm",
					poster: "/z_assets/videos/video-fallback.jpg"
				}, {
					volume: 1,
					playbackRate: 1,
					muted: true,
				...
				$(".video-background").vide({
					mp4: "/z_assets/videos/background-video.mp4",
					webm: "/z_assets/videos/background-video.webm",
					poster: "/z_assets/videos/video-poster.jpg"
				}, {
					volume: 1,
					playbackRate: 1,
					muted: true,
		...
		if($(".video-background-banner").length>0) {
			if (Modernizr.touch) {
				$(".video-background-banner").vide({
					mp4: "/z_assets/videos/background-video-banner.mp4",
					webm: "/z_assets/videos/background-video-banner.webm",
					poster: "/z_assets/videos/video-fallback.jpg"
				}, {
					volume: 1,
					playbackRate: 1,
				...
				$(".video-background-banner").vide({
					mp4: "/z_assets/videos/background-video-banner.mp4",
					webm: "/z_assets/videos/background-video-banner.webm",
					poster: "/z_assets/videos/video-banner-poster.jpg"
				}, {
					volume: 1,
					playbackRate: 1,
					muted: true,
