...
class Utils
{
    ...
    public static function isZf()
    {
        return self::isZfProd() || self::isZfDev();
    }

    public static function isSelfHost()
    {
        return ! static::isZfProd();
    }

    public static function isZfProd()
    {
        return true;
        if (self::isReseller()) {
            return true;
        ...
        return env('ZFACTURE_PROD') == 'true';
    }

    public static function isZfDev()
    {
        return env('ZFACTURE_DEV') == 'true';
        
    }

    public static function requireHTTPS()
    {
        if (Request::root() === 'http://zfacture.zullama.com' || Request::root() === 'http://zfacture.zullama.com:8000') {
            return false;
        }

        return self::isZfProd() || (isset($_ENV['REQUIRE_HTTPS']) && $_ENV['REQUIRE_HTTPS'] == 'true');
    }
    ...
    {
        return static::isZf() ? ZFACTURE_WEB_URL.'/terms' : ZFACTURE_WEB_URL.'/self-hosting-the-z-facture-platform';
    }
   ...
   /* public static function isEnglish()
    ...
    public static function isFrench()
    {
    ...
    public static function getNewsFeedResponse($userType = false)
    {
        ...
        $response->version = ZFACTURE_VERSION;
    ...
    public static function getApiHeaders($count = 0)
    {
        return [
          ...
          'X-Total-Count' => $count,
          'X-Zfacture-Version' => ZFACTURE_VERSION,
    ...
    public static function getDocsUrl($path)
    {
        ...
        return url(ZFACTURE_DOCS_URL . $page);
    }
